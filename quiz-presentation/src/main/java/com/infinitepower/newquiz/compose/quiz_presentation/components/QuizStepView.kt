...
internal fun QuizStepView(
    ...
    val backgroundColor = if (questionStep is QuestionStep.Current) {
        MaterialTheme.colorScheme.tertiary
    } else MaterialTheme.colorScheme.surface

    val stepBackgroundColor by animateColorAsState(targetValue = backgroundColor)

    val textColor = if (questionStep is QuestionStep.Current) {
        MaterialTheme.colorScheme.onTertiary
    } else MaterialTheme.colorScheme.onSurface

    val stepTextColor by animateColorAsState(targetValue = textColor)
