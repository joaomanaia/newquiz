...
import androidx.compose.ui.unit.dp
import com.infinitepower.footballagent.core.util.strings.Strings
import com.infinitepower.footballagent.core.util.strings.getString
...
internal fun TextFieldImpl(
    ...
    val shouldOverrideTextStyleColor =
        (titleMedium.color == Color.Unspecified && bodySmall.color != Color.Unspecified) ||
                (titleMedium.color != Color.Unspecified && bodySmall.color == Color.Unspecified)
